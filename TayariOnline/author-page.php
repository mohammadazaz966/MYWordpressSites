...
<section id="headerblogpost6">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="header-blogpost5-author-title">
                        <h3 class="title">Author Posts </h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="header-blogpost5-author-title">
                        <h3>No of Posts : <span><?php echo get_the_author_posts();?></span></h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                 <ul class="author-blogpost-list">
                                    <?php 
                     ...
                     <li class="author-blogpost-list-item">
                        <div class="col-4 p-0">
                            <div class="card style1 h-100">
