...
* Custom SLider.
*/
require get_template_directory() . '/template-parts/custom-slider.php';
...
function add_scripts(){
    ...
    /* addtoany core JavaScript */
	wp_enqueue_script('addtoany.js', get_template_directory_uri(). '/vendor/addtoany/addtoany.js', array('jquery'),1.1,true);
    /* Bootstrap core JavaScript */
	wp_enqueue_script('main.js', get_template_directory_uri(). '/js/main.js', array('jquery'),1.1,true);
	wp_enqueue_script('slide-carousel.js', get_template_directory_uri(). '/js/slide-carousel.js', array('jquery'),1.1,true);
	...
	wp_enqueue_script('heroslider.js', get_template_directory_uri(). '/js/heroslider.js',  'all');
}
